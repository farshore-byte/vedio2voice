# Video2Voice: 实时音频处理 pipeline

[Switch to English version 切换到英文版](README.md)

## 项目概述
Video2Voice 是一个基于 Python 的工具，可实时处理音频以提取、增强语音片段并按说话人聚类。它结合了语音活动检测（VAD）、语音增强和说话人识别技术，提供结构化的音频输出。与简单的音频提取不同，该工具处理原始音频流以隔离并按说话人组织语音。
